...
export default class Project extends React.Component<ProjectProp> {
    render() {
        return (
            <div className="px-4 py-8 bg-gray-400 max-w-xs rounded flex flex-col items-center justify-center z-10 m-4 relative">
                <div id="header wrapper" className="flex flex-row items-center justify-center w-full">
